...
export default function HomePage() {
  ...
  return (
    <><div className="min-h-screen bg-[#171535] text-white">
          {/* Added horizontal padding for mobile responsiveness */}
          <div className="mx-auto max-w-[90rem] px-4">
              <div className="py-10">
                  ...
                  {/* Main Tabs */}
                  <div className="flex flex-wrap space-x-8 text-2xl font-semibold">
                      {mainTabs.map((tab) => (
                          <button
                              key={tab}
                              onClick={() => handleMainTabClick(tab)}
                              className={`pb-2 transition-all ${activeMainTab === tab
                  ...
                  <div className="mt-8 flex flex-wrap gap-3">
                      {subTabsData[activeMainTab].map((subTab) => (
                          <button
                              ...
                              className={`px-5 py-3 text-lg rounded-md transition-all ${activeSubTab === subTab
      ...
      </div><ConsultationSection /><Footer /></>
  );
}
